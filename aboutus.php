 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">تعرف على مشروع الفنادق السياحية بمدينة الرياض</h3> 
						   <p class="about-para-w3ls"> مشروع يختص بجميع الفنادق السياحية بمدينة الرياض </p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/1.jpg" class="img-responsive" alt="Hair Salon">
										</div>
...
<div class="advantages">
	<div class="container">
		<div class="advantages-main">
				<h3 class="title-w3-agileits">خدماتنا</h3>
